/*
  Optical SP02 Detection (SPK Algorithm) using the MAX86916 Breakout
  ...
  was modified to work with the SparkFun MAX86916 library and to compile under Arduino 1.6.11
...
void setup()
{
  ...
  {
    Serial.println(F("MAX86916 was not found. Please check wiring/power."));
    while (1);
  }
  ...
  byte ledMode = 2; //Options: 1 = IR only, 2 = Red + IR, 3 = Red + IR + Green + Blue
  byte sampleRate = 100; //Options: 50, 100, 200, 400, 800, 1000, 1600, 3200
  int pulseWidth = 411; //Options: 70, 120, 220, 420
